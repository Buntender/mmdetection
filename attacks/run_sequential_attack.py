...
from detectors.mmdet_model_info import model_info
from detectors.vis_tool import voc2coco
from detectors.utils_mmdet import get_det, show_det, get_train_model, get_train_data, get_test_data, get_loss_from_dict
from mmdet.models.detectors import FasterRCNN, SingleStageDetector

FOLDER = "work_dirs_data0/CATA_VOC_FRCNN_YOLO"
for ap in range(6):
...
def main():
    ...
    model_list = ['Faster R-CNN', 'My YOLOv3']
    # model_list = ['My Faster R-CNN', 'MySSD']
    # model_list = ['My Faster R-CNN', 'MySSD Robust']
    ...
    for im_id in tqdm(test_image_ids[525:600]):
        try:
