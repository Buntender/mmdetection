...
model_info = {
    ...
    'My Faster R-CNN': {
        ...
        'checkpoint_file': 'work_dirs/faster_rcnn_r50_fpn_1x_voc/latest.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'
    },
    ...
    'MySSD': {
        'config_file': '/media/data4/lkz/mmdetection_stable_on_28_1124/robustdetector/configs/ssd300_voc.py',
        'checkpoint_file': '/media/data4/lkz/mmdetection_stable_on_28_1124/work_dirs/ssd300_voc/epoch_24.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/ssd/ssd512_coco/ssd512_coco_20200308-038c5591.pth'
    },

    'MySSD Robust': {
        'config_file': '/media/data4/lkz/mmdetection_stable_on_28_1124/robustdetector/configs/ssd300_voc.py',
        'checkpoint_file': '/media/data4/lkz/mmdetection_stable_on_28_allattacks/work_dirs/ssd300_voc_train0/latest.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/ssd/ssd512_coco/ssd512_coco_20200308-038c5591.pth'
    },
    ...
    'My YOLOv3': {
        ...
        'checkpoint_file': 'work_dirs_data0/yolov3_d53_mstrain-416_273e_voc/latest.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/yolo/yolov3_d53_mstrain-416_273e_coco/yolov3_d53_mstrain-416_273e_coco-2b60fcd9.pth'
    },
