...
def parse_args():
    ...
    parser.add_argument('--attack_images', type=int, default=None)
...
def main():
    ...
    if not distributed:
        ...
        outputs = single_gpu_test(model, data_loader, args.show, args.show_dir,
                                  args.show_score_thr, attack_images=args.attack_images)
    else:
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            # print(dataset.evaluate(outputs, **eval_kwargs)`1`)

            # visualize the precision_recall image, IoU=0.5
            eval_kwargs['precision_recall_visual'] = True
            eval_results, precision = dataset.evaluate(outputs, **eval_kwargs)
