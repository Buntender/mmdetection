...
server_program_path = ''
server_checkpoint_path = 'checkpoints/'
...
def parse_args():
    ...
    parser.add_argument(
        '--out_dir', default='result/PRFA/out', help='directory where painted images will be saved')
    parser.add_argument(
        '--vis_step_out_dir', default='result/PRFA/vis_step', help='directory where painted images will be saved')
    parser.add_argument(
        '--show-score-thr',
        type=float,
        default=0.3,
    ...
    # parser.add_argument('--attack', type=str, default='IoUzosignsgd_linf', help='Attack.')

    parser.add_argument('--exp_folder', type=str, default='result/PRFA/exp', help='Experiment folder to store all output.')
