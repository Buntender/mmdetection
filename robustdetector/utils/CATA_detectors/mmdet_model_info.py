...
model_info = {
    'Faster R-CNN': {
        ...
        'checkpoint_file': 'robustdetector/checkpoints/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth',
    ...
    'My Faster R-CNN': {
        'config_file': 'robustdetector/configs/faster_rcnn_r50_fpn_1x_voc.py',
        'checkpoint_file': 'robustdetector/checkpoints/faster_rcnn_r50_fpn_1x_voc_20230305.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/faster_rcnn/faster_rcnn_r50_fpn_1x_coco/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth'
    },

    'RetinaNet': {
        'config_file': 'configs/retinanet/retinanet_r50_fpn_1x_coco.py',
        'checkpoint_file': 'robustdetector/checkpoints/retinanet_r50_fpn_1x_coco_20200130-c2398f9e.pth',
    ...
    'MySSD': {
        'config_file': 'robustdetector/configs/ssd300_voc.py',
    ...
    'MySSDRobust': {
        'config_file': 'robustdetector/configs/ssd300_voc.py',
        'checkpoint_file': 'work_dirs/ssd300_voc_FreeRobust/latest.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/ssd/ssd512_coco/ssd512_coco_20200308-038c5591.pth'
    },

    'SSD': {
        'config_file': 'configs/ssd/ssd512_coco.py',
        'checkpoint_file': 'robustdetector/checkpoints/ssd512_coco_20200308-038c5591.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/ssd/ssd512_coco/ssd512_coco_20200308-038c5591.pth'
    },

    'YOLOv3': {
        'config_file': 'configs/yolo/yolov3_d53_mstrain-416_273e_coco.py',
        'checkpoint_file': 'robustdetector/checkpoints/yolov3_d53_mstrain-416_273e_coco-2b60fcd9.pth',
    ...
    'MyYOLOv3': {
        'config_file': 'robustdetector/configs/yolov3_d53_mstrain-416_273e_voc.py',
        'checkpoint_file': 'robustdetector/checkpoints/yolov3_d53_mstrain-416_273e_voc_20230305.pth',
        'download_link': 'http://download.openmmlab.com/mmdetection/v2.0/yolo/yolov3_d53_mstrain-416_273e_coco/yolov3_d53_mstrain-416_273e_coco-2b60fcd9.pth'
    },

    'GN+WS': {
        'config_file': 'configs/gn+ws/faster_rcnn_r50_fpn_gn_ws-all_1x_coco.py',
        'checkpoint_file': 'robustdetector/checkpoints/faster_rcnn_r50_fpn_gn_ws-all_1x_coco_20200130-613d9fe2.pth',
    ...
    'Libra R-CNN': {
        ...
        'checkpoint_file': 'robustdetector/checkpoints/libra_faster_rcnn_r50_fpn_1x_coco_20200130-3afee3a9.pth',
    ...
    #     'checkpoint_file': 'robustdetector/checkpoints/fcos_r50_caffe_fpn_gn-head_mstrain_640-800_2x_coco-d92ceeea.pth',
    ...
    'FoveaBox': {
        ...
        'checkpoint_file': 'robustdetector/checkpoints/fovea_r50_fpn_4x4_1x_coco_20200219-ee4d5303.pth',
    ...
    'FreeAnchor': {
        ...
        'checkpoint_file': 'robustdetector/checkpoints/retinanet_free_anchor_r50_fpn_1x_coco_20200130-0f67375f.pth',
    ...
    'DETR': {
        ...
        'checkpoint_file': 'robustdetector/checkpoints/detr_r50_8x2_150e_coco_20201130_194835-2c4b8974.pth',
    ...
    'Deformable DETR': {
        ...
        'checkpoint_file': 'robustdetector/checkpoints/deformable_detr_r50_16x2_50e_coco_20210419_220030-a12b9512.pth',
